# Launchpad admin guide

The manual for people who run a Launchpad install. It deploys onto a
...
```bash
npm install
npm run dev      # http://localhost:4321/apps/_admin-guide/
...
**`base` is `/apps/_admin-guide`.** A static app is served under `/apps/{slug}/`,
